...
if ($key !== ADMIN_KEY) {
    ...
    <head>
        ...
        <title>Export Center | CII MCM Trust</title>
    ...
    <body>
        <div class="login-card">
            ...
            <p>Enter the security key below to download the compiled student applications as an Excel CSV sheet.</p>
...
$csvFile = __DIR__ . '/secure_data/submissions.csv';
...
if (!file_exists($csvFile)) {
    ...
    <body>
        <div class="card">
            ...
            <p>There are currently no student applications stored on the server to export.</p>
...
header('Content-Disposition: attachment; filename="cii_mcm_applications_' . date('Ymd_His') . '.csv"');
